...
const Register = () => {
  ...
  const handleRegestration = async (e) =>{
    ...
    setSuccess(true)
      ...
      console.error('Regestration error: ', error.response.data)
    }finally{
      setLoading(false)
    }
  }
      ...
      <div className = 'row justify-content-center '>
        <div className ='col-md-6 bg-light-dark rounded p-5'>
          ...
          <form onSubmit = {handleRegestration}>
            ...
            {loading ?(
              <button type ='submit' className = ' text-light btn btn-outline-info d-block mx-auto' disabled><FontAwesomeIcon icon={faSpinner} spin/>Please Wait</button>
            ):(
